export default {
    ...
    createWalletPage: {
        ...
        please_save_wallet_file_line1:
            'ウォレットのパスワードはウォレットのロック解除に使用されます。適切に保管してください',
        ...
        find_wallet_file_in_download_directory:
            'ダウンロード後、ブラウザのダウンロードフォルダに移動して表示してください',
    ...
    checkTxPage: {
        title: '問い合わせ',
        query_now: '今すぐ問い合わせ',
        please_input_txid_or_address:
            'トランザクションハッシュ/アドレス/契約アドレスを入力してください。',
    },
    signRawPage: {
        title: 'サイン',
        sign_now: 'サイン',
    ...
    contractPage: {
        ...
        tx_not_on_chain_please_query_later:
            'トランザクションはまだチェーン上にありません。後でこのトランザクションIDを確認してください',
    ...
    registerAccount: {
        ...
        register_request_sent_please_refresh_later:
            '登録リクエストが送信されました。5秒待ってからインターフェースを更新してください。',
        ...
        register_account_error_with_reason:
            '登録に失敗した、残高が登録料を支払うのに十分でない可能性がある、またはアカウント名が登録されています',
    },
