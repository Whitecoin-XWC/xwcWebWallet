<template>
  <div>
    <div class="xwc-main-container xwc-transfer-container">
      <!-- transfer panel -->
      <div class="-left-side" v-if="step==='transfer'">
        <el-form
          ...
          ref="transferForm"
          label-width="60pt"
          class="xwc-transfer-inner-container"
        >
          ...
          <el-form-item v-bind:label="$t('transferPage.fee')" prop="feeAmount">
            <span class="label-font">0.001XWC</span>
          </el-form-item>
          <el-form-item>
            <el-button
              type="primary"
      ...
      <div class="-left-side" v-if="step==='transfer_sent'">
        ...
        <div style="margin-top: 15pt;">
          <el-button class="xwcwallet-form-btn" @click="backToTransfer">{{$t('transferPage.back')}}</el-button>
        </div>
      </div>
...
.xwc-transfer-inner-container,
.xwc-transfer-done-inner-container {
  width: 400pt;
