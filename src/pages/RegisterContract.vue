<template>
  <div>
    <div class="xwc-panel xwc-register-contract-container">
      <div class="-left-side" v-if="step==='transfer'">
        <el-form
          ...
          ref="contractForm"
          label-width="90pt"
          class="xwc-register-contract-inner-container"
        >
          ...
          <div>
            ...
            <el-row style="margin-bottom: 15pt;">
              ...
              <el-col :span="16">
                ...
                >{{xwcAmountToString(contractForm.fee && contractForm.fee.amount)}} XWC</div>
              </el-col>
            </el-row>
          </div>
...
export default {
  ...
  methods: {
    ...
    xwcAmountToString(val) {
      return utils.xwcAmountToString(val);
    }
  }
};
</script>
...
<style lang="less">
.xwc-register-contract-container {
  min-width: 400px;
  min-height: 381pt;
  background: inherit;
  padding-top: 0;
...
.xwc-register-contract-inner-container,
.xwc-register-contract-done-inner-container {
  min-width: 400pt;
