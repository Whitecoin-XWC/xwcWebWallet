<template>
  <div>
    <div class="xwc-panel xwc-invoke-contract-container">
      <div class="-left-side" v-if="step==='transfer'">
        <el-form
          ...
          ref="contractForm"
          label-width="60pt"
          class="xwc-invoke-contract-inner-container"
        >
          <el-form-item
          ...
          >
            ...
            <el-button
              type="primary"
              class="xwcwallet-form-btn -confirm-contract-address-btn"
          ...
          <el-form-item v-bind:label="$t('contractPage.balance')" prop="amount">
            <el-input
              ...
              type="text"
              :readonly="true"
              v-model="currentAccountXwcBalance"
              style
            >
...
.chrome-ext-app-container .xwc-invoke-contract-container {
  .-input-gas-price.asset-input-wrapper {
    .el-input {
...
.xwc-invoke-contract-inner-container,
.xwc-invoke-contract-done-inner-container {
  min-width: 500pt;
