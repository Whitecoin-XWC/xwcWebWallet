<template>
  <div>
    <div class="xwc-main-container xwc-customize-network-container">
      ...
      <div v-if="!customizeNetworkDone">
        <el-form
          ...
          label-width="90pt"
          class="xwc-customize-network-inner-container"
        >
      ...
      <div v-if="customizeNetworkDone" class="xwc-customize-network-done-container">
...
.xwc-customize-network-container2 {
  .label-font {
    color: #a99eb4;
    font-size: 8pt;
  }
}
.xwc-customize-network-container,
.xwc-customize-network-done-container {
  min-width: 400px;
  min-height: 266pt;
