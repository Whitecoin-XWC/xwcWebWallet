<template>
  <div>
    <div class="xwc-panel xwc-transfer-contract-container">
      <div class="-left-side" v-if="step==='transfer'">
        <el-form
          ...
          ref="contractForm"
          label-width="90pt"
          class="xwc-transfer-contract-inner-container"
        >
          ...
          <el-form-item label="Gas Price" prop="gasPrice">
            <AssetInput
              ...
              :hasAppend="true"
            >
              <template slot="append">XWC</template>
            </AssetInput>
          </el-form-item>
        ...
        >
          <div>
            ...
            <el-row style="margin-bottom: 15pt;">
              ...
              <el-col :span="16">
                <div class="grid-content label-font value-label">0.001XWC</div>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="8">
      ...
      <div class="-left-side" v-if="step==='contract_sent'">
        ...
        <div style="margin-top: 15pt;">
          <el-button class="xwcwallet-form-btn" @click="backToTransfer">{{$t('contractPage.return')}}</el-button>
        </div>
      </div>
...
export default {
      ...
      currentAccountBalances: [
        {
          ...
          assetSymbol: "XWC",
          amount: 0,
          precision: appState.xwcPrecision,
          amountNu: new BigNumber(0)
        }
      ],
      currentAccountXwcBalance: 0,
      currentAccountInfo: {},
      emulateState: null,
  ...
  methods: {
    onFlashTxMessage(txMsg) {
      ...
      this.contractForm.gasPrice = txMsg.gasPrice || "0.00000001";
    },
          ...
          return nodeClient
            ...
            .then(balances => {
              ...
              for (let asset of assets) {
                ...
                if (asset.id === "1.3.0") {
                  this.currentAccountXwcBalance = item.amountNu.toFixed(
                    asset.precision
                  );
                }
              }
    ...
    backToTransfer() {
      ...
      this.contractForm.gasPrice = "0.00000001";
    ...
    emulateTransferToContract() {
      ...
      const gasPrice = parseInt(
        gasPriceNu.multipliedBy(Math.pow(10, appState.xwcPrecision)).toFixed(0)
      );
...
<style lang="less">
.xwc-transfer-contract-container {
  min-width: 400px;
  min-height: 381pt;
  background: inherit;
...
.chrome-ext-app-container .xwc-transfer-contract-container {
  .-input-gas-price.asset-input-wrapper {
    .el-input {
...
.xwc-transfer-contract-inner-container,
.xwc-transfer-contract-done-inner-container {
  min-width: 360pt;
