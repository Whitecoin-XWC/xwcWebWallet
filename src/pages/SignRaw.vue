    ...
    <div class="xwc-main-container xwc-sign-raw-container">
      ...
      <div v-if="!signRawDone">
        <el-form
          ...
          ref="signRawForm"
          label-width="90pt"
          class="xwc-sign-raw-inner-container"
        >
          <div>
            <el-input
              class="-input-address"
          ...
          <div class="-option-signature">
            <el-switch
              ...
              :active-text="$t('signRawPage.text_signature')"
              :inactive-text="$t('signRawPage.transaction_signature')"
            ></el-switch>
          </div>
...
.xwc-sign-raw-container2 {
  .label-font {
    color: #a99eb4;
    font-size: 8pt;
  }
}
.xwc-sign-raw-container,
.xwc-sign-raw-done-container {
  min-width: 400px;
  min-height: 266pt;
  .-sign-raw-title {
    font-size: 2rem;
