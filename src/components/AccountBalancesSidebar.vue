<template>
  <div class="xwc-account-balances-side-bar">
      ...
      <div>
        <el-form :model="transferTokenForm">
          ...
          <el-form-item label="To address" :label-width="'120'">
            <el-input v-model="transferTokenForm.to" placeholder="only accept XWC address" autocomplete="on"></el-input>
          </el-form-item>
  ...
  methods: {
    ...
    filterBalances(balances, skipZero = false, limit = null) {
      ...
      if (filtered.length === 0) {
        filtered = [utils.emptyXwcBalance];
      }
      return filtered;
    },
