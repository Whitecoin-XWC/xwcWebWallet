<template>
  <div>
    ...
    <el-row class="-info-line-row">
      ...
      <el-col :span="16">
        <div class="grid-content label-font">
          <div>{{xwcAmountToString(operation.gas_price)}}</div>
        </div>
      </el-col>
    </el-row>
    <el-row class="-info-line-row">
      ...
      <el-col :span="16">
        <div class="grid-content label-font">
          <div>{{opTotalFee(operation.fee.amount, operation.invoke_cost, operation.gas_price)}} XWC</div>
        </div>
      </el-col>
    </el-row>
    <el-row class="-info-line-row">
...
export default {
  ...
  methods: {
    ...
    opTotalFee(opFeeAmount, gasCount, gasPrice) {
      ...
      return utils.xwcAmountToString(acctual_fee);
    },
